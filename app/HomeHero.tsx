          ...
          <div className="flex items-center flex-wrap sm:flex-nowrap gap-4 sm:gap-8 w-full">
            ...
            >
              <div className="sm:max-w-lg">
                ...
                <Typography variant="p" className="max-w-[80%] mb-10 font-bold">
                  Join our Future City platform to apply
                </Typography>
            ...
            >
              <img
                ...
                className="h-[300px] sm:h-full sm:max-h-[75vh] w-auto overflow-hidden"
              />
            </motion.div>
          </div>
        </motion.div>

...
const typographyVariants = cva("text-foreground", {
  variants: {
    variant: {
      h1: "scroll-m-20 text-5xl font-bold tracking-tight lg:text-7xl xl:text-8xl text-white",
      h2: "scroll-m-20 text-4xl font-bold tracking-tight lg:text-6xl xl:text-7xl text-white",
      h3: "scroll-m-20 text-3xl font-bold tracking-tight lg:text-5xl text-white",
      h4: "scroll-m-20 text-2xl font-bold tracking-tight lg:text-4xl text-white",
      h5: "scroll-m-20 text-xl font-semibold tracking-tight lg:text-3xl text-white",
      h6: "scroll-m-20 text-lg font-semibold tracking-tight lg:text-xl text-white",
